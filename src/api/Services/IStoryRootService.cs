...
public interface IStoryRootService
{
    ...
    Task<StoryRoot?> GetCurrentStoryRootAsync();
    ...
    Task<StoryRoot?> GetStoryRootVersionAsync(string versionId);
    ...
    Task<StoryRoot> ProposeStoryRootMergeAsync(string rawInput);
    ...
    Task<string> CommitStoryRootVersionAsync(StoryRoot proposal, string? identity = null);
}
